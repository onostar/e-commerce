<section class="top_head" id="topHeader">
    ...
    <header>
        ...
        <div class="search">
            <form class="form-inline" action="view/search_result.php" method="GET">
        ...
        <div class="login_option" id="account">
            <div>
                <a href="view/account.php" class="signupBtn">My Profile</a>
                <a href="view/order_history.php" class="signupBtn">My orders</a>
        ...
        <?php if(isset($_SESSION['user'])){?>
            <div class="cart">
                <a href="view/shopping_cart.php" title="view cart"><i class="fas fa-shopping-cart"></i> Cart <span id="cart_value">
                    <?php
