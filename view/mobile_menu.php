<div id="mobile_menu">
    ...
    <aside id="asideLeft">
        <div class="login">
            ...
            ?>
            <button id="loginDiv"><i class="far fa-user"></i> <a href="view/login_page.php">Sign in</a> <i class="fas fa-sign-in-alt"></i></button>
            <?php }?>
        </div>
        <nav id="index_nav">
            <ul>
        ...
        <nav id="help">
            <ul>
                <li>
                    ...
                    <li>
                        <a href="report_product.php" title="who we are">
