<?php
    ...
    if(isset($_SESSION['user'])){
        ...
        $title = $full_name. " - Help center - Refunds";
    }else{
                ...
                <div class="help_details" id="placeOrder">
                    <div class="place_order_tips">
                        ...
                        <div class="order_tips">
                            <p>All items on Rivicos Online store are strictly under a return and refund policy enacted by Rivicos. <br>Customers are expected to get exactly what they ordered for, if there is a breach of contract, the customer shall duely refund payments and be purnished by the Rivicos team.</p>
                        </div>
                    </div>
                </div>
