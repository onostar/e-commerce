<?php
    ...
    if(isset($_GET['order'])){
        ...
        if($dispense_item){
            ...
            $subject = "Items Dispensed for delivery";
            $details = "Hello $full_name, your orders, with order number: $order_id has been dispensed for delivery to your address. \n Thanks for your business. Do Shop more with Us";
            ...
            $from_name = "Realcare";
            $name = 'Realcare order';
            $subj = "orders dispensed for delivery";
            $msg = "<p>Hello $full_name, your order with order number: $order_id has been dispensed for delivery to your address. <br>Your item will BE delivered to you shortly! Thanks for your business. Do Shop more with Realcare</p>";
